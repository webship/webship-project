[![Build Status](https://travis-ci.org/webship/webship.svg?branch=11.0.x)](https://travis-ci.com/github/webship/webship/builds) 11.0.x
...
To install the dev version of Webship 11.0.x run this command:
```
